...
export default function Contact() {
   ...
   return (
      <div className="min-h-screen pt-24 sm:pt-32 pb-16 sm:pb-20 bg-cream/30 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
         {/* Background accents */}
         ...
         <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-10 sm:gap-20">
            <div className="lg:w-1/2">
               <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brown mb-6 sm:mb-8 tracking-tighter">Get in <br /><span className="text-sage">Touch.</span></h1>
               <p className="text-base sm:text-xl text-brown/60 font-light leading-relaxed mb-8 sm:mb-12 max-w-md">
            ...
            <div className="lg:w-1/2">
               <div className="glass-panel p-5 sm:p-10 md:p-14 bg-white/70 shadow-2xl relative">
                  {submitted ? (
